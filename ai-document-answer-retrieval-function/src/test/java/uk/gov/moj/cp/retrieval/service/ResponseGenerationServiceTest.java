...
class ResponseGenerationServiceTest {
    ...
    void setUp() {
        ...
        responseGenerationService = new ResponseGenerationService(mockChatService, citationProcessor);
    }
    ...
    void generateResponse_ReturnsTrimmedAndCitationFormattedResponse_WhenChatServiceReturnsValidResponse() throws ChatServiceException {
        ...
        final String processedResponse = "Some random processed response";
        ...
        when(citationProcessor.processAndFormatCitations(mockResponse)).thenReturn(processedResponse);
