...
public class ResponseGenerationService {
    ...
    private final ChunkFormatterService chunkFormatterService;
    ...
    public ResponseGenerationService() {
        ...
        chunkFormatterService = new ChunkFormatterService();
        userInstructionService = new UserInstructionService();
    }

    public ResponseGenerationService(final ChatService chatService, final CitationProcessor citationProcessor, final ChunkFormatterService chunkFormatterService, final UserInstructionService userInstructionService) {
        this.chatService = chatService;
        this.citationProcessor = citationProcessor;
        this.chunkFormatterService = chunkFormatterService;
    ...
    public String generateResponse(final String userQuery, final List<ChunkedEntry> chunkedEntries, final String userQueryPrompt) {
        ...
        final String formattedChunks = chunkFormatterService.buildChunkContext(chunkedEntries);
